...
public final class ModelServiceGrpc {
  ...
  public static final io.grpc.MethodDescriptor<tensorflow.serving.GetModelStatus.GetModelStatusRequest,
      tensorflow.serving.GetModelStatus.GetModelStatusResponse> METHOD_GET_MODEL_STATUS = getGetModelStatusMethodHelper();
  ...
  public static io.grpc.MethodDescriptor<tensorflow.serving.GetModelStatus.GetModelStatusRequest,
      tensorflow.serving.GetModelStatus.GetModelStatusResponse> getGetModelStatusMethod() {
    return getGetModelStatusMethodHelper();
  }

  private static io.grpc.MethodDescriptor<tensorflow.serving.GetModelStatus.GetModelStatusRequest,
      tensorflow.serving.GetModelStatus.GetModelStatusResponse> getGetModelStatusMethodHelper() {
  ...
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  @java.lang.Deprecated // Use {@link #getHandleReloadConfigRequestMethod()} instead. 
  public static final io.grpc.MethodDescriptor<tensorflow.serving.ModelManagement.ReloadConfigRequest,
      tensorflow.serving.ModelManagement.ReloadConfigResponse> METHOD_HANDLE_RELOAD_CONFIG_REQUEST = getHandleReloadConfigRequestMethodHelper();
  ...
  public static io.grpc.MethodDescriptor<tensorflow.serving.ModelManagement.ReloadConfigRequest,
      tensorflow.serving.ModelManagement.ReloadConfigResponse> getHandleReloadConfigRequestMethod() {
    return getHandleReloadConfigRequestMethodHelper();
  }

  private static io.grpc.MethodDescriptor<tensorflow.serving.ModelManagement.ReloadConfigRequest,
      tensorflow.serving.ModelManagement.ReloadConfigResponse> getHandleReloadConfigRequestMethodHelper() {
  ...
  public static abstract class ModelServiceImplBase implements io.grpc.BindableService {
    ...
    public void getModelStatus(tensorflow.serving.GetModelStatus.GetModelStatusRequest request,
      ...
      asyncUnimplementedUnaryCall(getGetModelStatusMethodHelper(), responseObserver);
    }
    ...
    public void handleReloadConfigRequest(tensorflow.serving.ModelManagement.ReloadConfigRequest request,
      ...
      asyncUnimplementedUnaryCall(getHandleReloadConfigRequestMethodHelper(), responseObserver);
    }

    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            getGetModelStatusMethodHelper(),
            asyncUnaryCall(
              new MethodHandlers<
          ...
          .addMethod(
            getHandleReloadConfigRequestMethodHelper(),
            asyncUnaryCall(
              new MethodHandlers<
  ...
  public static final class ModelServiceStub extends io.grpc.stub.AbstractStub<ModelServiceStub> {
    ...
    public void getModelStatus(tensorflow.serving.GetModelStatus.GetModelStatusRequest request,
        io.grpc.stub.StreamObserver<tensorflow.serving.GetModelStatus.GetModelStatusResponse> responseObserver) {
      asyncUnaryCall(
          getChannel().newCall(getGetModelStatusMethodHelper(), getCallOptions()), request, responseObserver);
    }
    ...
    public void handleReloadConfigRequest(tensorflow.serving.ModelManagement.ReloadConfigRequest request,
        io.grpc.stub.StreamObserver<tensorflow.serving.ModelManagement.ReloadConfigResponse> responseObserver) {
      asyncUnaryCall(
          getChannel().newCall(getHandleReloadConfigRequestMethodHelper(), getCallOptions()), request, responseObserver);
    }
  }
  ...
  public static final class ModelServiceBlockingStub extends io.grpc.stub.AbstractStub<ModelServiceBlockingStub> {
    ...
    public tensorflow.serving.GetModelStatus.GetModelStatusResponse getModelStatus(tensorflow.serving.GetModelStatus.GetModelStatusRequest request) {
      return blockingUnaryCall(
          getChannel(), getGetModelStatusMethodHelper(), getCallOptions(), request);
    }
    ...
    public tensorflow.serving.ModelManagement.ReloadConfigResponse handleReloadConfigRequest(tensorflow.serving.ModelManagement.ReloadConfigRequest request) {
      return blockingUnaryCall(
          getChannel(), getHandleReloadConfigRequestMethodHelper(), getCallOptions(), request);
    }
  }
  ...
  public static final class ModelServiceFutureStub extends io.grpc.stub.AbstractStub<ModelServiceFutureStub> {
    ...
    public com.google.common.util.concurrent.ListenableFuture<tensorflow.serving.GetModelStatus.GetModelStatusResponse> getModelStatus(
      ...
      return futureUnaryCall(
          getChannel().newCall(getGetModelStatusMethodHelper(), getCallOptions()), request);
    }
    ...
    public com.google.common.util.concurrent.ListenableFuture<tensorflow.serving.ModelManagement.ReloadConfigResponse> handleReloadConfigRequest(
      ...
      return futureUnaryCall(
          getChannel().newCall(getHandleReloadConfigRequestMethodHelper(), getCallOptions()), request);
    }
  }
      ...
      synchronized (ModelServiceGrpc.class) {
        ...
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
              ...
              .addMethod(getGetModelStatusMethodHelper())
              .addMethod(getHandleReloadConfigRequestMethodHelper())
              .build();
        }
      }
    }
