...
public final class SessionServiceGrpc {
  ...
  @java.lang.Deprecated // Use {@link #getSessionRunMethod()} instead. 
  public static final io.grpc.MethodDescriptor<tensorflow.serving.SessionServiceOuterClass.SessionRunRequest,
      tensorflow.serving.SessionServiceOuterClass.SessionRunResponse> METHOD_SESSION_RUN = getSessionRunMethodHelper();
  ...
  public static io.grpc.MethodDescriptor<tensorflow.serving.SessionServiceOuterClass.SessionRunRequest,
      tensorflow.serving.SessionServiceOuterClass.SessionRunResponse> getSessionRunMethod() {
    return getSessionRunMethodHelper();
  }

  private static io.grpc.MethodDescriptor<tensorflow.serving.SessionServiceOuterClass.SessionRunRequest,
      tensorflow.serving.SessionServiceOuterClass.SessionRunResponse> getSessionRunMethodHelper() {
  ...
  public static abstract class SessionServiceImplBase implements io.grpc.BindableService {
    ...
    public void sessionRun(tensorflow.serving.SessionServiceOuterClass.SessionRunRequest request,
      ...
      asyncUnimplementedUnaryCall(getSessionRunMethodHelper(), responseObserver);
    }

    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            getSessionRunMethodHelper(),
            asyncUnaryCall(
              new MethodHandlers<
  ...
  public static final class SessionServiceStub extends io.grpc.stub.AbstractStub<SessionServiceStub> {
    ...
    public void sessionRun(tensorflow.serving.SessionServiceOuterClass.SessionRunRequest request,
        io.grpc.stub.StreamObserver<tensorflow.serving.SessionServiceOuterClass.SessionRunResponse> responseObserver) {
      asyncUnaryCall(
          getChannel().newCall(getSessionRunMethodHelper(), getCallOptions()), request, responseObserver);
    }
  }
  ...
  public static final class SessionServiceBlockingStub extends io.grpc.stub.AbstractStub<SessionServiceBlockingStub> {
    ...
    public tensorflow.serving.SessionServiceOuterClass.SessionRunResponse sessionRun(tensorflow.serving.SessionServiceOuterClass.SessionRunRequest request) {
      return blockingUnaryCall(
          getChannel(), getSessionRunMethodHelper(), getCallOptions(), request);
    }
  }
  ...
  public static final class SessionServiceFutureStub extends io.grpc.stub.AbstractStub<SessionServiceFutureStub> {
    ...
    public com.google.common.util.concurrent.ListenableFuture<tensorflow.serving.SessionServiceOuterClass.SessionRunResponse> sessionRun(
      ...
      return futureUnaryCall(
          getChannel().newCall(getSessionRunMethodHelper(), getCallOptions()), request);
    }
  }
      ...
      synchronized (SessionServiceGrpc.class) {
        ...
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
              ...
              .addMethod(getSessionRunMethodHelper())
              .build();
        }
      }
    }
